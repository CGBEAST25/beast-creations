      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
        <div className="col-span-1 md:col-span-1">
          <Link to="/" className="flex items-center space-x-2 mb-6 group">
            <Aperture className="w-6 h-6 text-beast-blue group-hover:rotate-45 transition-transform" />
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li><Link to="/studio" className="text-zinc-500 hover:text-white transition-colors text-sm">About</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="https://www.instagram.com/beastcreations.ai" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-beast-blue transition-colors"><Instagram className="w-5 h-5" /></a>
            <a href="https://x.com/Beast_creations" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-beast-blue transition-colors"><Twitter className="w-5 h-5" /></a>
            <a href="https://www.linkedin.com/company/beastcreations" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-beast-blue transition-colors"><Linkedin className="w-5 h-5" /></a>
          </div>
        </div>
      </div>
